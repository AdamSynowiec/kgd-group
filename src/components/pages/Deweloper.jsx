...
import heroBg from '../../assets/images/image00018.png';
import NavBar from '../blocks/NavBar'
import TimeLine from '../blocks/TimeLine'
import FeatureImage from '../layout/FeatureImage'
import dom from '../../assets/images/zielona-polana01.png'
import dom2 from '../../assets/images/KRJ3___TOP_C 1.png'
...
const Deweloper = () => {
    ...
    return (
        <Section className='overflow-x-hidden'>
            <Helmet>
                <title>KGD Building Strategiczne doradztwo dla inwestycji deweloperskich</title>
                <meta name="description" content="KGD Building oferuje profesjonalne doradztwo dla inwestycji deweloperskich, wspierając firmy w planowaniu, finansowaniu i realizacji projektów mieszkaniowych i komercyjnych." />
                <meta name="keywords" content="KGD Building, doradztwo inwestycyjne, inwestycje deweloperskie, wsparcie deweloperów, planowanie projektów, finansowanie inwestycji" />
            </Helmet>
            ...
            <Container>
                ...
                <Section className='py-[32.0px] md:py-[40px] md:py-[80px]'>
                    ...
                    <P>Legitymujemy się bogatym doświadczeniem w branży deweloperskiej dlatego stworzyliśmy
                        KGD Building aby dzielić się wiedzą z deweloperami oraz inwestorami chcącymi rozwinąć swoją przygodę na tym lukratywnym jednak bardzo wymagającym i trudnym rynku.</P>
                </Section>
                ...
                <Section className='py-[32.0px] md:py-[40px] md:py-[80px]'>
                    ...
                    <Feature
                        ...
                        <ul class='list-disc pl-6'>
                            ...
                            <li>Zapewniamy terminową realizację zgodną z harmonogramem</li>
                        </ul>
                    "
                    />
                    <Feature
                    ...
                    <Feature
                        ...
                        content="
                        <p>Kompleksowym wykończeniem wnętrz zajmuje się TEC Remodeling, który jest częścią KGD Group. Firma ma za sobą ponad 600 zrealizowanych remontów oraz wykończeń. Posiadamy nowoczesny sprzęt, zaplecze logistyczne oraz duży zespół specjalistów i fachowców branżowych. Dysponujemy własnych biurem architektonicznym TEC Architects, które zaprojektuje designerskie i funkcjonalne wnętrza wg. Twoich wytycznych.</p>
                        <ul class='list-disc pl-6'>
                            ...
                            <li>Zapewniamy terminową realizację prac wykończeniowych</li>
            ...
            <FeatureImage src={dom2} title="Korzyści ze współpracy z KGD" subtitle="Kompleksowe wsparcie inwestycji – oszczędność czasu, większy zysk, mniejsze ryzyko i wysoka jakość realizacji, która buduje Twoją markę." />
            <Section className='bg-[#ffffff]'>
                <Container>
                    <Section className='py-[32.0px] md:py-[40px] md:py-[80px]'>
                        <H3 className='!font-extralight text-center '>Skorzystaj z naszego doświadczenia i zrealizuj swoją inwestycję jak profesjonalista. Umów się na bezpłatną konsultację, podczas której omówimy Twój projekt i przedstawimy konkretne rozwiązania.</H3>
