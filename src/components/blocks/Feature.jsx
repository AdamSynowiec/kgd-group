    ...
    return (
        <div className='border-b border-[#EEEEEE] py-[32.0px] md:py-[40px]'>
            <div className="flex flex-col sm:flex-row items-start">
                <div class="aspect-square w-[80px] h-[80px] md:w-[100px] md:h-[100px] lg:w-[100px] lg:h-[100px] bg-[#C9AB8B] rounded-[15px] flex items-center justify-center z-10 mb-[32.1px] md:mb-0"><h2 class="text-[#C9AB8B]
