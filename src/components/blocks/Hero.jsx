                ...
                <div className="absolute bottom-[70px] left-6 right-6 flex flex-row justify-between">
                    <div className="">
                        <svg width="51" height="27" viewBox="0 0 51 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M49.7082 1.125L25.4998 25.3333L1.2915 1.125" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                            ...
                            <li className='w-[40px] h-[40px] border border-white rounded-full flex items-center justify-center'>
                                <Link to={'https://x.com'}>
                                    <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M12.795 8.533L19.68 0H16.607L11.352 6.517L6.69 0H0L7.806 10.91L0.47 20H3.544L9.249 12.93L14.31 20H21L12.795 8.533ZM10.415 11.483L8.97 9.464L3.36 1.627H5.67L10.198 7.944L11.641 9.964L17.659 18.373H15.349L10.415 11.483Z" fill="white" />
                                    </svg>
                                </Link>
                            </li>
                        </ul>
